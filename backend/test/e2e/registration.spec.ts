...
// Kegunaan: Mengelompokkan skenario pengujian tentang "Candidate Registration"
test.describe('Candidate Registration', () => {
  ...
  // Kegunaan: Mengelompokkan skenario pengujian tentang "Step 1: Account Creation"
  test.describe('Step 1: Account Creation', () => {
    // Kegunaan: Memulai eksekusi pengujian dengan judul "should display step 1 form initially"
    test('should display step 1 form initially', async () => {
      await registrationPage.expectStep1Visible();
    });

    // Kegunaan: Memulai eksekusi pengujian dengan judul "should show error if neither email nor phone provided"
    ...
    // Kegunaan: Memulai eksekusi pengujian dengan judul "should show error if passwords do not match"
    ...
    // Kegunaan: Memulai eksekusi pengujian dengan judul "should prevent submission if password too short (browser validation)"
    ...
    // Kegunaan: Memulai eksekusi pengujian dengan judul "should proceed to step 2 with email only"
    ...
    // Kegunaan: Memulai eksekusi pengujian dengan judul "should proceed to step 2 with phone only"
    ...
    // Kegunaan: Memulai eksekusi pengujian dengan judul "should proceed to step 2 with both email and phone"
  ...
  // Kegunaan: Mengelompokkan skenario pengujian tentang "Step 2: Personal Info"
  test.describe('Step 2: Personal Info', () => {
    ...
    // Kegunaan: Memulai eksekusi pengujian dengan judul "should show error if required fields are empty"
    ...
    // Kegunaan: Memulai eksekusi pengujian dengan judul "should proceed to step 3 with valid data"
  ...
  // Kegunaan: Mengelompokkan skenario pengujian tentang "Step 3: Education"
  test.describe('Step 3: Education', () => {
    ...
    // Kegunaan: Memulai eksekusi pengujian dengan judul "should display education form"
    ...
    // Kegunaan: Memulai eksekusi pengujian dengan judul "should proceed to step 4 with valid data"
  ...
  // Kegunaan: Mengelompokkan skenario pengujian tentang "Step 4: Source Tracking and Completion"
  test.describe('Step 4: Source Tracking and Completion', () => {
    ...
    // Kegunaan: Memulai eksekusi pengujian dengan judul "should display source tracking form"
    test('should display source tracking form', async () => {
      // Kegunaan: Memastikan elemen tersebut benar-benar terlihat di layar oleh pengguna
      await expect(registrationPage.selectSourceType).toBeVisible();
    });

    // Kegunaan: Memulai eksekusi pengujian dengan judul "should complete registration and redirect to portal"
    ...
    // Kegunaan: Memulai eksekusi pengujian dengan judul "should show detail field for referral source types"
...
// Kegunaan: Mengelompokkan skenario pengujian tentang "Candidate Login"
test.describe('Candidate Login', () => {
  ...
  // Kegunaan: Memulai eksekusi pengujian dengan judul "should display login form"
  ...
  // Kegunaan: Memulai eksekusi pengujian dengan judul "should show error for invalid credentials"
  test('should show error for invalid credentials', async () => {
    await loginPage.login('invalid@example.com', 'wrongpassword');
    await loginPage.expectErrorMessage('salah');
  });

  // Kegunaan: Memulai eksekusi pengujian dengan judul "should login with correct email and password"
  test('should login with correct email and password', async () => {
    await loginPage.login(testEmail, testPassword);
    await loginPage.expectRedirectToPortal();
  });

  // Kegunaan: Memulai eksekusi pengujian dengan judul "should login with correct phone and password"
...
// Kegunaan: Mengelompokkan skenario pengujian tentang "Duplicate Account Prevention"
test.describe('Duplicate Account Prevention', () => {
  ...
  // Kegunaan: Memulai eksekusi pengujian dengan judul "should show error when registering with existing email"
  ...
  // Kegunaan: Memulai eksekusi pengujian dengan judul "should show error when registering with existing phone"
...
// Kegunaan: Mengelompokkan skenario pengujian tentang "Registration with Tracking Parameters"
test.describe('Registration with Tracking Parameters', () => {
  // Kegunaan: Memulai eksekusi pengujian dengan judul "should preserve ref parameter through registration"
  ...
  // Kegunaan: Memulai eksekusi pengujian dengan judul "should preserve campaign parameter through registration"
