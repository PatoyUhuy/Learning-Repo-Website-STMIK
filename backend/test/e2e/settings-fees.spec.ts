...
// Kegunaan: Mengelompokkan skenario pengujian tentang "Settings - Fee Structure Management"
test.describe('Settings - Fee Structure Management', () => {
  ...
  test.describe('Page Load', () => {
    // Kegunaan: Memulai eksekusi pengujian dengan judul "should display fees page with table"
    ...
    // Kegunaan: Memulai eksekusi pengujian dengan judul "should display academic year selector"
    test('should display academic year selector', async () => {
      // Kegunaan: Memastikan elemen tersebut benar-benar terlihat di layar oleh pengguna
      await expect(feesPage.academicYearSelect).toBeVisible();
    });

    // Kegunaan: Memulai eksekusi pengujian dengan judul "should display add fee button"
  ...
  // Kegunaan: Mengelompokkan skenario pengujian tentang "Fee Display"
  test.describe('Fee Display', () => {
    // Kegunaan: Memulai eksekusi pengujian dengan judul "should display fee type columns in table header"
  ...
  // Kegunaan: Mengelompokkan skenario pengujian tentang "Fee CRUD"
  test.describe('Fee CRUD', () => {
    ...
    // Kegunaan: Memulai eksekusi pengujian dengan judul "should add new fee structure via HTMX"
    ...
    // Kegunaan: Memulai eksekusi pengujian dengan judul "should toggle fee status via HTMX"
    ...
    // Kegunaan: Memulai eksekusi pengujian dengan judul "should edit fee amount"
    ...
    // Kegunaan: Memulai eksekusi pengujian dengan judul "should display edit button for each fee"
