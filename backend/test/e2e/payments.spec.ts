...
// Kegunaan: Mengelompokkan skenario pengujian tentang "Payments - Portal Display"
test.describe('Payments - Portal Display', () => {
  ...
  // Kegunaan: Memulai eksekusi pengujian dengan judul "should display payments page with summary cards"
  ...
  // Kegunaan: Memulai eksekusi pengujian dengan judul "should display bank info"
  ...
  // Kegunaan: Memulai eksekusi pengujian dengan judul "should display payments list"
...
// Kegunaan: Mengelompokkan skenario pengujian tentang "Payments - With Billing"
test.describe('Payments - With Billing', () => {
  // Kegunaan: Memulai eksekusi pengujian dengan judul "should show empty state when no billings"
...
// Kegunaan: Mengelompokkan skenario pengujian tentang "Admin Payment Review"
test.describe('Admin Payment Review', () => {
  // Kegunaan: Memulai eksekusi pengujian dengan judul "finance user can access payment review page"
  ...
  // Kegunaan: Memulai eksekusi pengujian dengan judul "admin can also access payment review page"
  ...
  // Kegunaan: Memulai eksekusi pengujian dengan judul "consultant cannot access payment review page"
  ...
  // Kegunaan: Memulai eksekusi pengujian dengan judul "finance user can filter payments by status"
  ...
  // Kegunaan: Memulai eksekusi pengujian dengan judul "finance user can approve payment"
  ...
  // Kegunaan: Memulai eksekusi pengujian dengan judul "finance user can reject payment with reason"
...
// Kegunaan: Mengelompokkan skenario pengujian tentang "Candidate Search API"
test.describe('Candidate Search API', () => {
  // Kegunaan: Memulai eksekusi pengujian dengan judul "search API returns results for valid query"
  ...
  // Kegunaan: Memulai eksekusi pengujian dengan judul "search API requires minimum 2 characters"
