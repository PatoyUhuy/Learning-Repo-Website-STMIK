...
// Kegunaan: Mengelompokkan skenario pengujian tentang "Candidate Reassignment"
test.describe('Candidate Reassignment', () => {
  // Kegunaan: Mengelompokkan skenario pengujian tentang "Modal Behavior"
  test.describe('Modal Behavior', () => {
    // Kegunaan: Memulai eksekusi pengujian dengan judul "should open reassign modal when clicking reassign button"
    ...
    // Kegunaan: Memulai eksekusi pengujian dengan judul "should close modal when clicking close button"
    ...
    // Kegunaan: Memulai eksekusi pengujian dengan judul "should close modal when clicking cancel button"
    ...
    // Kegunaan: Memulai eksekusi pengujian dengan judul "should display consultant list with workload info"
  ...
  // Kegunaan: Mengelompokkan skenario pengujian tentang "Access Control"
  test.describe('Access Control', () => {
    // Kegunaan: Memulai eksekusi pengujian dengan judul "consultant should not see reassign button"
    ...
    // Kegunaan: Memulai eksekusi pengujian dengan judul "supervisor should be able to open reassign modal"
  ...
  // Kegunaan: Mengelompokkan skenario pengujian tentang "Reassignment Flow"
  test.describe('Reassignment Flow', () => {
    // Kegunaan: Memulai eksekusi pengujian dengan judul "should successfully reassign candidate to different consultant"
    ...
    // Kegunaan: Memulai eksekusi pengujian dengan judul "should log reassignment in interaction timeline"
