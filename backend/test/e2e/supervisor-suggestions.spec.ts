...
// Kegunaan: Mengelompokkan skenario pengujian tentang "Supervisor Suggestions"
test.describe('Supervisor Suggestions', () => {
  // Kegunaan: Mengelompokkan skenario pengujian tentang "Add Suggestion"
  test.describe('Add Suggestion', () => {
    // Kegunaan: Memulai eksekusi pengujian dengan judul "supervisor should see add suggestion form on interactions without suggestions"
    ...
    // Kegunaan: Memulai eksekusi pengujian dengan judul "consultant should not see add suggestion form"
    ...
    // Kegunaan: Memulai eksekusi pengujian dengan judul "supervisor should be able to add suggestion"
    ...
    // Kegunaan: Memulai eksekusi pengujian dengan judul "admin should be able to add suggestion"
  ...
  // Kegunaan: Mengelompokkan skenario pengujian tentang "Mark As Read"
  test.describe('Mark As Read', () => {
    // Kegunaan: Memulai eksekusi pengujian dengan judul "consultant should be able to mark suggestion as read"
  ...
  // Kegunaan: Mengelompokkan skenario pengujian tentang "Notification Badge"
  test.describe('Notification Badge', () => {
    // Kegunaan: Memulai eksekusi pengujian dengan judul "consultant should see unread suggestions badge in sidebar"
