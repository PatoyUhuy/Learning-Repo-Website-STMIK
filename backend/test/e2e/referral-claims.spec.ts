...
// Kegunaan: Mengelompokkan skenario pengujian tentang "Referral Claims Management"
test.describe('Referral Claims Management', () => {
  // Kegunaan: Mengelompokkan skenario pengujian tentang "Referral Claims List"
  test.describe('Referral Claims List', () => {
    // Kegunaan: Memulai eksekusi pengujian dengan judul "admin can access referral claims page"
    ...
    // Kegunaan: Memulai eksekusi pengujian dengan judul "referral claims page shows unverified claims"
  ...
  // Kegunaan: Mengelompokkan skenario pengujian tentang "Link Referral Claim"
  test.describe('Link Referral Claim', () => {
    // Kegunaan: Memulai eksekusi pengujian dengan judul "admin can open link referrer modal"
    ...
    // Kegunaan: Memulai eksekusi pengujian dengan judul "admin can link claim to existing referrer"
  ...
  // Kegunaan: Mengelompokkan skenario pengujian tentang "Invalid Referral Claim"
  test.describe('Invalid Referral Claim', () => {
    // Kegunaan: Memulai eksekusi pengujian dengan judul "admin can mark claim as invalid"
