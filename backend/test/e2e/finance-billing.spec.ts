...
// Kegunaan: Mengelompokkan skenario pengujian tentang "Finance Billing Management"
test.describe('Finance Billing Management', () => {
  // Kegunaan: Mengelompokkan skenario pengujian tentang "Billing List"
  test.describe('Billing List', () => {
    // Kegunaan: Memulai eksekusi pengujian dengan judul "finance user can access billing list page"
    ...
    // Kegunaan: Memulai eksekusi pengujian dengan judul "admin can also access billing list page"
    ...
    // Kegunaan: Memulai eksekusi pengujian dengan judul "consultant cannot access billing list page"
  ...
  // Kegunaan: Mengelompokkan skenario pengujian tentang "Create Billing"
  test.describe('Create Billing', () => {
    // Kegunaan: Memulai eksekusi pengujian dengan judul "finance user can create billing for candidate"
    ...
    // Kegunaan: Memulai eksekusi pengujian dengan judul "billing form validates required fields"
  ...
  // Kegunaan: Mengelompokkan skenario pengujian tentang "Edit Billing"
  test.describe('Edit Billing', () => {
    // Kegunaan: Memulai eksekusi pengujian dengan judul "finance user can edit unpaid billing"
    ...
    // Kegunaan: Memulai eksekusi pengujian dengan judul "finance user can cancel unpaid billing"
  ...
  // Kegunaan: Mengelompokkan skenario pengujian tentang "Billing Filters"
  test.describe('Billing Filters', () => {
    // Kegunaan: Memulai eksekusi pengujian dengan judul "finance user can filter billings by status"
    ...
    // Kegunaan: Memulai eksekusi pengujian dengan judul "finance user can filter billings by type"
    ...
    // Kegunaan: Memulai eksekusi pengujian dengan judul "finance user can search billings by candidate"
